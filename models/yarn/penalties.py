...
class Penalty(object):
    ...
    @abstractmethod
    def get_penalized_runtime(self, ideal, available, running_time, error_offset=0):
...
class StepPenalty(BumpPenalty):
    def get_penalized_runtime(self, ideal, available, running_time, error_offset=0):
        ...
        return int((self.initial_bump + error_offset) * running_time)
...
class PercentagePenalty(BumpPenalty):
    ...
    def get_penalized_runtime(self, ideal, available, running_time, error_offset=0):
        ...
        additional_penalty_before_ideal = running_time * (self.initial_bump - 1 + error_offset)
